...
CREATE TABLE Slots (
Doctor_ID varchar(16) PRIMARY KEY,
...
d.Details,
dd.Dept_Position,
string_agg(d.Speciality,', ' ORDER BY d.Speciality) AS Specialities
FROM Users u
...
GROUP BY u.User_ID, u.First_Name, u.Last_Name, u.User_Profile, d.Details, dd.Dept_Position;
...
string_agg(dept.Speciality,', ') AS Specialities
...
GROUP BY
a.Appointment_ID, a.Appointment_Date, a.Appointment_Time, a.Appointment_Status,
a.Doctor_ID,d.First_Name,d.Last_Name,a.Patient_ID,p.First_Name,p.Last_Name;
...
GROUP BY
a.Appointment_ID,a.Appointment_Date,a.Appointment_Time,a.Appointment_Status,
a.Doctor_ID,d.First_Name,d.Last_Name,a.Patient_ID,p.First_Name,p.Last_Name,t.Diagnosis,t.Prescription,t.Notes;

INSERT INTO Users (
  User_ID, Email_ID, Sex, Date_Of_Birth, Address,
  First_Name, Last_Name, User_Type, Phone_Number,
  User_Profile, Password, User_Status
) VALUES
('ADMIN','admin@123.com','F','1970-01-01', '', 'Admin','Superuser','ADMIN','9999999999','{}','$2b$14$hV74sc/onROU.XzHk.2TiOfVTOVQkhkRhEoI5S343yjGNGN.kUuTO','ACTIVE'),
